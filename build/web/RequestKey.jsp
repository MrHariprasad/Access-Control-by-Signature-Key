<%-- 
    Document   : RequestKey
    Created on : 18 Feb, 2023, 12:32:36 PM
    Author     : GKV
--%>
...
<body>
 ...
 String role=(String)session.getAttribute("role");
             ...
             <%try{
                 ...
                 if(skey.equals("waiting")){
                     %>
                     <h3> <font color="red"> YOUR DON'T HAVE ANY SECRET KEY <a href="KeyRequest.jsp?id=<%=r.getString("id")%>"><font color="blue">Send Key Request</font></a></font></h3>
                     <%
                 }else{
%>
<h3><font color="red">YOUR KEY IS : <%=skey%></font></h3>
<%
}
             }catch(Exception e){

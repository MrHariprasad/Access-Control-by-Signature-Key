<%-- 
    ...
    Created on : 18 Feb, 2023, 10:09:58 AM
    Author     : GKV
--%>
  ...
  <!--header section start -->
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
              <h1 class="services_taital">CREATE : <font color="red">GROUPS</font></h1>
           <form action="CGroupAction.jsp" method="post">
                                    <table>
                                        <tr><th>Group Name</th><td><input type="text" name="gname" required=""></td></tr>
                                     
                                        <tr><th></th><td><input type="submit" value="AddGroup"><a href="CreateGroups.jsp?s=view"> <input type="button" value="View Groups" style="color:red"></a></td></tr>
              ...
              if(s!=null){%>
              <h2 style="margin-top:100px;">View Groups</h2>
                 <table border="1">
                  <tr><th>Sr.No</th><th>Group Name</th></tr>
              <%
              try{

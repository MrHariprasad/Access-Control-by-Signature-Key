<%-- 
    ...
    Created on : 18 Feb, 2023, 9:41:37 AM
    Author     : GKV
--%>
  ...
  <!--header section start -->
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
              <h1 class="services_taital">CREATE : <font color="red">ROLES</font></h1>
           <form action="CRoleAction.jsp" method="post">
                                    <table>
                                        <tr><th>New Role</th><td><input type="text" name="role" required=""></td></tr>
                                     
                                        <tr><th></th><td><input type="submit" value="AddRole"><a href="CreateRoles.jsp?s=view"> <input type="button" value="View Roles" style="color:red"></a></td></tr>
              ...
              if(s!=null){%>
              <h2 style="margin-top:100px;">View Roles</h2>
                 <table border="1">
                  <tr><th>Sr.No</th><th>Role Name</th></tr>
              <%
              try{

<%-- 
    Document   : Register
    Created on : 18 Feb, 2023, 10:47:16 AM
    Author     : GKV
--%>
    ...
    <div class="header_section">
      <div class="header_left">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="Client.jsp">User</a>
              </li>
              <li class="nav-item">
        ...
        <div class="banner_main">
          <h1 style="margin-top: 100px;">Register Here<br></h1>
          <form action="RegAction.jsp" method="post">
                                    <table>
                                     ...
                                     <tr><th></th><td>Already Have An Account ? <a href="Client.jsp">Login</a></td></tr>    
                                    </table>
                                    </form>
        </div>
      </div>

<%-- 
    ...
    Created on : 18 Feb, 2023, 11:38:39 AM
    Author     : GKV
--%>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8" style="height:700px;">
              <h1 class="services_taital">VIEW : <font color="red">ALL USERS</font></h1>
              ...
              try{
                  ...
                  while(r.next()){
                    String status=r.getString("role");
                      %>
                  <tr>
                      ...
                      <td><%=r.getString("name")%></td>
                       <td><%=r.getString("email")%></td>
                        <td><%=r.getString("mobile")%></td>
                         ...
                         <td><a href="ViewAllUsers.jsp?id=<%=r.getString("id")%>">Assign Role</a></td>
                         <%}else{
%>
<td><%=status%></td>
<%
